import { countryName, flagEmoji } from './cards.js?v=160-curated-card-skins';
...
HT HM VA HN HK HU IS IN ID IR IQ IE IM IL IT JM JE JO KZ KE KI KP KR KW KG LA LV LB LS LR LY LI LT LU MO MG MW MY MV ML MT MH MQ MR MU YT MX FM MD MC MN ME MS MA MZ MM
...
export function countryOptions(locale = 'uz') {
  return COUNTRY_CODES.map((code) => ({
    code,
    flag: flagEmoji(code),
    name: countryName(code, locale),
    label: `${flagEmoji(code)} ${countryName(code, locale) || code}`,
